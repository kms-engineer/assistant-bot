...
class TestEmailNormalizer:
    ...
    def test_normalize_valid_email(self, input_email, expected_normalized, validator_available):
        """Tests normalization of valid email strings."""
        with patch('src.presentation.nlp.normalizers.email_normalizer.EMAIL_VALIDATOR_AVAILABLE', validator_available):
