...
EMAIL:
  ...
  change-email <name> <new email>  - Change email address in an existing contact
  delete-email <name>              - Delete email in an existing contact if set

ADDRESS:
  add-address <name> <address>     - Add address to contact
  change-address <name> <address>  - Change address in an existing contact
  delete-address <name>            - Delete address in an existing contact if set

BIRTHDAY:
  add-birthday <name> <DD.MM.YYYY> - Add birthday to contact
  birthdays <amount>               - Show upcoming birthdays for <amount> days ahead or 7 days by default (max=365)
  delete-birthday <name>           - Delete birthday from contact
  show-birthday <name>             - Show contact's birthday

NOTES:
  add-note <title> <text>          - Add new note with title and text
  add-tag <id> <tag>               - Add a tag to a note
  change-note <id> <new text>      - Change note text by ID
  change-note-title <id> <title>   - Change note title by ID
  ...
  delete-tag <id> <tag>            - Delete a tag from a note
...
PHONE:
  ...
  Delete phone 555-1234 from John                        - Delete phone

EMAIL:
  Add email john@example.com to John                   - Add email
  Change John's email to new@mail.com                  - Change email
  Delete email from John                               - Delete email

ADDRESS:
  Add address 123 Main St Apt 5B, Chicago, IL 60601   - Add address
  Change John's address to 456 Oak Ave, Austin, TX    - Change address
  Delete address from John                            - Delete address

BIRTHDAY:
  Add birthday 15.03.1990 to John                      - Set birthday
  Show birthdays for next 30 days                      - Upcoming birthdays
  Delete birthday from John                            - Delete birthday
...
NOTES:
  ...
  Delete tag #work from note a1b2c3d4-e5f6-7890-abcd-...      - Delete tag
