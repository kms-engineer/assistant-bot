...
class CommandHandler:
    ...
    def __init__(
        ...
        self.commands: Dict[str, Callable] = {
            ...
            "delete-phone": self._wrap(contact_commands.remove_phone),
            ...
            "delete-birthday": self._wrap(contact_commands.remove_birthday),
            "birthdays": self._wrap(contact_commands.birthdays),
            "add-email": self._wrap(contact_commands.add_email),
            "change-email": self._wrap(contact_commands.edit_email),
            "delete-email": self._wrap(contact_commands.remove_email),
            "add-address": self._wrap(contact_commands.add_address),
            "change-address": self._wrap(contact_commands.edit_address),
            "delete-address": self._wrap(contact_commands.remove_address),
            ...
            "change-note-title": self._wrap_note(note_commands.rename_note),
            "change-note": self._wrap_note(note_commands.edit_note),
            ...
            "delete-tag": self._wrap_note(note_commands.remove_tag),
