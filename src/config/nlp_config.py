...
class NLPConfig:
    ...
    CATEGORY_KEYWORDS: Dict[str, Set[str]] = {
        "add": {
            "add", "create", "new", "attach", "set", "insert",
            "save", "register"
        },
        "edit": {
        ...
        "remove": {
            "remove", "delete", "clear", "erase", "drop", "unset",
            "destroy"
        },
        "search": {
            "search", "find", "lookup", "locate", "get", "show me",
            "where", "which"
        },
        "show": {
            "show", "list", "display", "view", "all", "print",
            "output", "see"
        },
    }
    ...
    CATEGORY_TO_INTENTS: Dict[str, List[str]] = {
        "add": [
            "add_contact", "add_email", "add_address", "add_birthday",
            "add_note", "add_note_tag"
        ],
        "edit": [
            "edit_phone", "edit_email", "edit_address", "edit_note"
        ],
        "remove": [
        ...
        "show": [
            "show_phone", "show_birthday", "show_notes", "show_note",
            "list_all_contacts", "list_birthdays", "list_note_tags"
        ],
    }
    ...
    INTENT_PATTERNS: Dict[str, List[Dict]] = {
        ...
        "edit_phone": [
            {
                "required": [["change", "edit", "update", "modify"], ["phone", "number"]],
                "optional": [],
                "confidence": 0.90
            },
        ],
        ...
        "search_contacts": [
            {
                "required": [["search", "find", "lookup", "locate"], ["contact", "person"]],
