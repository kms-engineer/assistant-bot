...
@mcp.tool(title='Edit contact email',
...
@mcp.tool(title='Add email to contact',
...
@mcp.tool(title='Remove contact email',
...
@mcp.tool(title='Edit contact address',
...
@mcp.tool(title='Add address to contact',
...
@mcp.tool(title='Remove contact address',
...
@mcp.tool(title='Save address book',
...
@mcp.tool(title='Load address book',
...
@mcp.tool(title='Get contact birthday',
...
@mcp.tool(title='Add birthday to contact',
...
@mcp.tool(title='Get upcoming birthdays',
...
@mcp.tool(title='Get contact phones',
...
@mcp.tool(title='Change contact phone',
...
@mcp.tool(title='Get contacts current filename',
...
@mcp.tool(title='Delete note by id',
...
@mcp.tool(title='Delete note by title',
...
@mcp.tool(title='Delete notes by tag',
...
@mcp.tool(title='Add tag to note',
          tags={"notes", "tags", "add"},
...
@mcp.tool(title='Remove tag from note',
...
@mcp.tool(title='Get all notes',
          tags={"notes", "list"},
          description="Return all loaded notes")
def get_all_notes():
    return note_service.get_all_notes()


@mcp.tool(title='Find note by title',
...
@mcp.tool(title='Search notes by content',
...
@mcp.tool(title='Search notes by title',
...
@mcp.tool(title='Search notes by tag',
...
@mcp.tool(title='Get notes grouped by tag',
...
@mcp.tool(title='Get notes current filename',
          tags={"notes", "metadata"},
...
if __name__ == '__main__':
    # Используем stdio транспорт для Claude Desktop
